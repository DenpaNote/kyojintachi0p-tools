package {
    ...
    public class PackImg extends Sprite {
        ...
        public function PackImg() {
            ...
            var result: File = new File("/Applications/去人たちZERO -prologue-.app/Contents/Resources/data/img.dat");
            ...
            statement.text = "CREATE TABLE IF NOT EXISTS " + "imagetbl" + "(" + "id TEXT NOT NULL PRIMARY KEY, " + "filename TEXT, " + "type TEXT, " + "extension TEXT, " + "data BLOB NOT NULL, " + "description TEXT, " + "metadata TEXT, " + "modificationdate TEXT, " + "lastupdate TEXT" + ")";
            statement.execute();
            
            var dumpJson: File = new File("/Users/yazawazi/Developer/焊/img_dump/dump.json");
            ...
            for (var i: int = 0; i < jsonObjects.length; i++) {
                ...
                var data: ByteArray = readFileContents(new File("/Users/yazawazi/Developer/焊/img_dump/" + filename));
                ...
                insertStatement.text = "INSERT INTO " + "imagetbl" + " (id, filename, type, extension, data, description, metadata, modificationdate, lastupdate) VALUES (:id, :filename, :type, :extension, :data, :description, :metadata, :modificationdate, :lastupdate)";
